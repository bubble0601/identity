 ...
 *
 * <p>{@link PlayerIdentityComponent#identity} being null represents "no identity," and accessors should check for this before using the field.
 */
public class PlayerIdentityComponent extends IdentityComponent {

    private final PlayerEntity player;

    public PlayerIdentityComponent(PlayerEntity player) {
        this.player = player;
    }
    ...
    /**
     * Sets the identity of this {@link PlayerIdentityComponent}.
     *
